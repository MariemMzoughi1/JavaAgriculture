...
public class GrangeService implements InterfaceCRUD<Grange> {
    ...
    public void add(Grange g) {
        ...
        String req = "INSERT INTO grange (type_grange, capacite, zone_id, productivite) VALUES (?, ?, ?, ?)";
        try {
    ...
    @Override
    public void update(Grange g) {
        String req = "UPDATE grange SET type_grange = ?, capacite = ?, zone_id = ?, productivite = ? WHERE id = ?";

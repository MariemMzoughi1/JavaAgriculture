...
import Controllers.forum.ModifierPost;
...
public class AdminDetailsForum {
    ...
    private void handleModifier() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AdminModifierPost.fxml"));
            Stage stage = new Stage();
            stage.setScene(new Scene(loader.load()));

            AdminModifierPost controller = loader.getController();

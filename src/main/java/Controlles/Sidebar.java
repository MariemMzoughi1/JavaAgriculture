...
public class Sidebar {
    ...
    @FXML
    private void ouvrirZones() {
        chargerVue("ListeZonesUser.fxml");
    }

    @FXML
    private void ouvrirGranges() {
        chargerVue("ListeGrangesUser.fxml");
    }

    public void chargerVue(String vue) {
        try {
    ...
    public void chargerVueAvecZone(String vue, Zone zone) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/" + vue));
            Node content = loader.load();

            // Passage de la zone au contrôleur
            ...
            e.printStackTrace();
            System.out.println("Erreur lors du chargement de la vue avec Zone : " + vue);
        }
    }
